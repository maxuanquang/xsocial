...
var file_authen_and_post_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x22, 0x29, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x6f, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x22, 0xc2, 0x01,
	...
	0x41, 0x74, 0x2a, 0x23, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x12, 0x06, 0x0a, 0x02, 0x4f, 0x4b, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x4e, 0x4f, 0x54, 0x5f,
	0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x01, 0x32, 0x9e, 0x03, 0x0a, 0x13, 0x41, 0x75, 0x74, 0x68,
	...
	0x1b, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x5f, 0x61, 0x6e, 0x64, 0x5f, 0x70, 0x6f, 0x73,
	0x74, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12, 0x4d,
	...
	,
...
var file_authen_and_post_proto_goTypes = []interface{}{
	...
	(*UserDetailInfo)(nil), // 2: authen_and_post.UserDetailInfo
	(*UserResult)(nil),     // 3: authen_and_post.UserResult
	(*UserFollower)(nil),   // 4: authen_and_post.UserFollower
	(*GetPostRequest)(nil), // 5: authen_and_post.GetPostRequest
	(*Post)(nil),           // 6: authen_and_post.Post
}
var file_authen_and_post_proto_depIdxs = []int32{
	0, // 0: authen_and_post.UserResult.status:type_name -> authen_and_post.UserStatus
	2, // 1: authen_and_post.UserResult.info:type_name -> authen_and_post.UserDetailInfo
	1, // 2: authen_and_post.UserFollower.followers:type_name -> authen_and_post.UserInfo
	1, // 3: authen_and_post.AuthenticateAndPost.CheckUserAuthentication:input_type -> authen_and_post.UserInfo
	2, // 4: authen_and_post.AuthenticateAndPost.CreateUser:input_type -> authen_and_post.UserDetailInfo
	2, // 5: authen_and_post.AuthenticateAndPost.EditUser:input_type -> authen_and_post.UserDetailInfo
	1, // 6: authen_and_post.AuthenticateAndPost.GetUserFollower:input_type -> authen_and_post.UserInfo
	5, // 7: authen_and_post.AuthenticateAndPost.GetPostDetail:input_type -> authen_and_post.GetPostRequest
	3, // 8: authen_and_post.AuthenticateAndPost.CheckUserAuthentication:output_type -> authen_and_post.UserResult
	3, // 9: authen_and_post.AuthenticateAndPost.CreateUser:output_type -> authen_and_post.UserResult
	3, // 10: authen_and_post.AuthenticateAndPost.EditUser:output_type -> authen_and_post.UserResult
	4, // 11: authen_and_post.AuthenticateAndPost.GetUserFollower:output_type -> authen_and_post.UserFollower
	6, // 12: authen_and_post.AuthenticateAndPost.GetPostDetail:output_type -> authen_and_post.Post
